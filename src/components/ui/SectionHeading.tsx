...
export const SectionHeading: React.FC<SectionHeadingProps> = ({
  ...
  return (
    ...
    >
      {badge && (
        <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-500 glass-panel rounded-full border border-cyan-500/20 mb-3">
      ...
      <div
        className={`mt-4 h-1 w-20 rounded-full bg-gradient-to-r from-cyan-500 to-violet-600 ${
          centered ? "mx-auto" : ""
        }`}
      />
    </div>
