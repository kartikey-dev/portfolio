...
export const SectionHeading: React.FC<SectionHeadingProps> = ({
  ...
  return (
    ...
    >
      {badge && (
        <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#709FA8] glass-panel rounded-full border border-[#709FA8]/30 mb-3">
          <span className="h-1.5 w-1.5 rounded-full bg-[#709FA8] animate-pulse" />
          {badge}
        </span>
      )}
