...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "UX Implementation: Transformed wireframes into interactive web applications, ensuring semantic markup, responsive layouts across devices, and accessibility compliance.",
    ...
    technologies: ["HTML5", "CSS3", "JavaScript", "Bootstrap", "jQuery", "Semantic HTML", "WCAG"],
  },
  {
    id: "upturn",
